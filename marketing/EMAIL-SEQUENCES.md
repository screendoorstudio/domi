# DoMi Email Nurture Sequences

## Overview
Email sequences to nurture leads from EDDM campaigns and website visitors through to app installation and activation.
...
Your Quick Win: The average American receives 41 pounds of junk mail per year. Starting today, that number goes down.
...
### Email 2: Feature Highlight - Opt-Out
**Trigger:** After Email 1
**Delay:** 2 days
**Subject:** The 3 types of junk mail clogging your mailbox (and how to stop them)
...
### Email 3: Feature Highlight - Digital Mailbox
**Trigger:** After Email 2
**Delay:** 3 days
**Subject:** What if junk mail actually paid YOU?
...
2. Brands pay to send you digital offers
3. You get a cut - up to $100/month

**The math:**
- Average offer value to brand: $0.42
- Your share: 50%
- View 10 offers/day = $63/month

**Why brands love it:**
- They only reach people who opted IN
- Higher engagement rates
- No printing/postage costs
- Measurable results

**Enable your Digital Mailbox** in the app settings to start earning.
...
### Email 4: Social Proof + Nudge
**Trigger:** After Email 3
**Delay:** 4 days
**Subject:** "I stopped 47 pieces of mail in my first month"
...
"The digital offers are actually relevant. I saved $200 on home repairs last month." - Marcus T., Birmingham
...
### Email 5: Urgency + CTA
**Trigger:** After Email 4
**Delay:** 5 days
**Subject:** Your mailbox is still getting junk (here's why)

```
Hi {first_name},

Quick check-in: Are you still getting junk mail?

If so, here's why:
- **Not verified yet?** Address verification unlocks the opt-out features
- **Haven't scanned mail?** We can only stop what you report
- **New senders?** Mailing lists get shared - keep scanning
...
Most users see a noticeable reduction within 30 days.
...
P.S. Reply to this email if you're having any trouble. I read every response.
```

---

## Sequence 2: Re-Engagement (Inactive Users)

### Email 1: We Miss You
**Trigger:** No app open in 14 days
**Delay:** Immediate
**Subject:** Your junk mail is piling up
...
**Trigger:** After Re-Engagement Email 1
**Delay:** 5 days
...
**2. Better Scanning**
Our AI now recognizes more mail types automatically - just point and shoot.

**3. Earnings Update**
Digital Mailbox users are now averaging ${average_earnings}/month in their first 90 days.
...
**Trigger:** After Re-Engagement Email 2
**Delay:** 7 days
...
## Sequence 3: Champion/Referral Program
...
**What you get:**
- $10 for every neighbor who signs up and verifies
...
### Email 2: Champion Toolkit
**Trigger:** User accepts Champion invitation
**Delay:** Immediate
**Subject:** Your Neighborhood Champion toolkit is ready

```
Hi {first_name},

Welcome to the Champion program! Here's everything you need:

**Your personal referral link:**
{referral_link}

(Each sign-up with this link = $10 for you)
...
- [Printable flyer for community boards]
...
## Sequence 4: Seasonal/Milestone

### Holiday Volume Warning
**Timing:** Early November
**Subject:** Brace yourself: Holiday junk mail is coming

```
Hi {first_name},

Between November and January, junk mail volume increases by 40%.

Holiday catalogs, end-of-year charity appeals, credit card offers for "holiday shopping" - it's about to get intense.

**Your pre-holiday checklist:**

[ ] Scan any lingering junk mail (clear the backlog)
...
- Estimated paper saved: {paper_saved} lbs
- Trees saved: {trees_saved}
- Digital offers viewed: {digital_views}
...
- CTA: Single primary action per email
...
| Sequence | Emails | Total Duration |
|----------|--------|----------------|
| Welcome | 5 | 14 days |
| Re-engagement | 3 | 12 days |
| Champion | 2 | Immediate |
| Seasonal | 1 | As scheduled |
| Milestone | 1 | Triggered |

### Frequency Rules
- Max 1 email per day
- Max 3 emails per week
- Suppress during re-engagement if user becomes active
- Always respect unsubscribes immediately
